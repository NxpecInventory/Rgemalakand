...
{
    public class CollegeFilesadminController : Controller
    {
        ...
        public ActionResult Create(uploadingfileviewmodel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (model.file != null && model.file.ContentLength > 0)
                {
                    ...
                    var getname = (from alias in db.CollegeEmployees where alias.Id == collegefiles.uploderid select alias.EmployeeName).FirstOrDefault();
